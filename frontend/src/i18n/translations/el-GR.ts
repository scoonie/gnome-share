export default {
  ...
  "home.bullet.a.description": "Φιλοξενήστε το Gnome Share στο δικό σας μηχάνημα.",
  ...
  "admin.config.config-file-warning.description": "As you have a configured Gnome Share with a configuration file, you can't change the configuration through the UI.",
  ...
  "admin.config.general.app-url.description": "Η διεύθυνση URL όπου το Gnome Share είναι διαθέσιμο",
