export default {
  ...
  "home.bullet.a.description": "Gnome Share'i kendi sunucunuzda barındırın.",
  ...
  "admin.config.config-file-warning.description": "Gnome Share'i bir yapılandırma dosyası ile kurduğunuz için, yapılandırmayı arayüz üzerinden değiştiremezsiniz.",
  ...
  "admin.config.general.app-url.description": "Gnome Share'in erişilebilir olduğu URL",
  ...
  "admin.config.cache.redis-enabled.description": "Normalde Gnome Share bilgileri bellekte önbellekler. Birden fazla Gnome Share örneği çalıştırıyorsanız, örnekler arasında önbelleği paylaşmak için Redis önbelleklemesini etkinleştirmeniz gerekir.",
