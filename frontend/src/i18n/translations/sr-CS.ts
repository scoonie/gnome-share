export default {
  ...
  "home.bullet.a.description": "Hostujte Gnome Share na svojoj mašini.",
  ...
  "admin.config.config-file-warning.description": "Pošto ste konfigurisali Gnome Share pomoću konfiguracionog fajla, ne možete menjati konfiguraciju putem korisničkog interfejsa (UI).",
  ...
  "admin.config.general.app-url.description": "Na kojoj URL adresi je dostupan Gnome Share",
  ...
  "admin.config.cache.redis-enabled.description": "Gnome Share obično kešira informacije u memoriji. Ako pokrećete više instanci Gnome Share-a, potrebno je da omogućite Redis keširanje kako bi se keš delio između instanci.",
