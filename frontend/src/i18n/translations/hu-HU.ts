export default {
  ...
  "home.bullet.a.description": "A Gnome Share megosztót saját gépéről futtathatja.",
  ...
  "admin.config.general.app-url.description": "A Gnome Share megosztáskezelőre mutató hivatkozás",
