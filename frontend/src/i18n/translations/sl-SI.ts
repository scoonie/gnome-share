export default {
  ...
  "home.bullet.a.description": "Gostuj Gnome Share na svoji lastni napravi.",
  ...
  "admin.config.general.app-url.description": "Na katerem URL-ju je dostopen Gnome Share",
