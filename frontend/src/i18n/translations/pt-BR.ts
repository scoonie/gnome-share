export default {
  ...
  "home.bullet.a.description": "Hospede o Gnome Share em sua própria máquina.",
  ...
  "admin.config.config-file-warning.description": "Como você tem um Gnome Share configurado com um arquivo de configuração, você não pode alterar a configuração através da UI.",
  ...
  "admin.config.general.app-url.description": "Em qual URL o Gnome Share está disponível",
  ...
  "admin.config.cache.redis-enabled.description": "Normalmente informações de caches Gnome Share na memória. Se você executar várias instâncias do Gnome Share, você precisa habilitar o cache do Redis para compartilhar o cache entre as instâncias.",
