export default {
  ...
  "home.bullet.a.description": "Hostujte Gnome Share na svém vlastním počítači.",
  ...
  "admin.config.config-file-warning.description": "Jelikož je Gnome Share nastaven pomocí konfiguračního souboru, nemůžete změnit nastavení přes UI.",
  ...
  "admin.config.general.app-url.description": "Na kterém URL je Gnome Share k dispozici",
