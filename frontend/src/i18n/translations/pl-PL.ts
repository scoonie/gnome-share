export default {
  ...
  "home.bullet.a.description": "Utrzymuj Gnome Share na własnym serwerze.",
  ...
  "admin.config.general.app-url.description": "Pod którym adresem URL Gnome Share jest dostępny",
