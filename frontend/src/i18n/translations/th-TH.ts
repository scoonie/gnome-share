export default {
  ...
  "home.bullet.a.description": "โฮสต์ Gnome Share บนเครื่องของคุณเอง.",
  ...
  "admin.config.general.app-url.description": "URL ที่สามารถเข้าถึงแอพพลิเคชัน Gnome Share ได้",
