export default {
  ...
  "home.bullet.a.description": "Hébergez Gnome Share sur votre propre machine.",
  ...
  "admin.config.config-file-warning.description": "Puisque vous avez configuré Gnome Share avec un fichier de configuration, vous ne pouvez pas modifier la configuration via l'interface utilisateur.",
  ...
  "admin.config.general.app-url.description": "Depuis quel URL Gnome Share est disponible",
  ...
  "admin.config.cache.redis-enabled.description": "Usuellement, Gnome Share conserve les informations en mémoire vive. Si vous exécutez plusieurs instances de Gnome Share, vous devez activer la mise en cache Redis pour partager le cache entre ces instances.",
