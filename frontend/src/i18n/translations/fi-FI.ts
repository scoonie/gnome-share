export default {
  ...
  "home.bullet.a.description": "Isännöi \"Gnome Share\" omalla palvelimellasi.",
  ...
  "admin.config.general.app-url.description": "Millä URL-osoitteella Gnome Share on saatavilla",
