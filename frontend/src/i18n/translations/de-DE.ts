export default {
  ...
  "home.bullet.a.description": "Betreibe Gnome Share auf deinem eigenen Server.",
  ...
  "admin.config.config-file-warning.description": "Da Gnome Share mit einer Konfigurationsdatei konfiguriert ist, kann die Konfiguration nicht über die Benutzeroberfläche geändert werden.",
  ...
  "admin.config.general.app-url.description": "Auf welcher URL Gnome Share verfügbar ist",
  ...
  "admin.config.cache.redis-enabled.description": "Normally Gnome Share caches information in memory. If you run multiple instances of Gnome Share, you need to enable Redis caching to share the cache between the instances.",
